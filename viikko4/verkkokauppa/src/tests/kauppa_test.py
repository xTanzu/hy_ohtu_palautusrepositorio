...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_eri_ostoksen_joista_toinen_loppu_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        # tehdään vaihtoehoinen toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            elif tuote_id == 2:
